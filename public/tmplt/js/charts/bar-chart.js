(function ($) {
 "use strict";
	...
	var barchart1 = new Chart(ctx, {
		type: 'bar',
		data: {
			labels: ["'#nama_kandidat'", "'#nama_kandidat'", "'#nama_kandidat'", "'#nama_kandidat'", "'#nama_kandidat'", "'#nama_kandidat'", "'#nama_kandidat'", "'#nama_kandidat'", "'#nama_kandidat'"],
			datasets: [{
				label: '#keterangan_sesi',
				data: [12, 19, 3, 5, 12, 3, 6 ,7, 9],
				backgroundColor: [
					'rgba(255, 99, 132, 0.2)',
					'rgba(255, 99, 132, 0.2)',
					'rgba(255, 99, 132, 0.2)',
