...
@section('page_title')
    Registrasi Klien Manual | Panel Admin SB Voting
@endsection
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-3"></div>
                    <form id="adminpro-register-form" class="adminpro-form" action="{{route('klien.store')}}" method="POST"  enctype="multipart/form-data">
                        @csrf
                        <div class="col-lg-6">
                            <div class="login-bg">
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="login-title">
                                            <h1>Formulir Registrasi Klien</h1>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="login-input-area">
                                            <input type="email"  placeholder="Masukkan Email Aktif" name="email_klien" id="email_klien">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="login-input-area register-mg-rt">
                                                    <input type="text" placeholder="Gelar Depan Anda" name="gelar_depan" id="gelar_depan">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="login-input-area register-mg-rt">
                                                    <input type="text" placeholder="Gelar Belakang Anda" name="gelar_belakang" id="gelar_belakang">
                                                    <i class="fa fa-user login-user"></i>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="login-input-area">
                                            <input type="text" placeholder="Masukkan Nomor WhatsApp Anda" name="wa" id="wa">
                                            <i class="fa fa-user login-user"></i>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="login-input-area">
                                            <input type="text" placeholder="Masukkan Instansi" name="instansi" id="instansi">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="login-horizental cancel-wp pull-left">
                                            ...
                                            <input type="submit" id="basicSuccessImageKlien" class="btn btn-success" type="submit" value="Registrasi Klien">
                                        </div>
                                    </div>
                                </div>
                            </div>
