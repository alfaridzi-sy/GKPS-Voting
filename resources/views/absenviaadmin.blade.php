...
@section('page_title')
    Absen Via Admin| Panel Admin SB Voting
@endsection
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Absensi Manual Via Admin</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <h2>Apakah Anda Yakin Untuk Mengisikan Absen Peserta Sceara Manual?</h2>
                                            </div>
                                            <div class="modal-footer">
                                                <a data-dismiss="modal" href="#">Batalkan</a>
                                                <a class="Alert Alert-color" href="{{ route('index') }}">Simpan</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <div class="sparkline12-hd">
                                                    <div class="main-sparkline12-hd">
                                                        ...
                                                        <div class="tab-content-details shadow-reset">
                                                            <h2>Halaman Pengisian Data Absensi Klien Peserta Voting
                                                                Untuk Sesi '#id_sesi', '#keterangan_sesi' Secara Manual
                                                                Via Admin Panel</h2>
                                                    ...
                                                    <form action="#">
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label
                                                                        class="login2 pull-right pull-right-pro">Keterangan
                                                                        Sesi</label>
                                                                </div>
                                                                <div class="col-lg-4">
                                                                    <div class="login-textarea-area">
                                                                        <textarea class="contact-message" cols="110"
                                                                            rows="5" placeholder="#keterangan_sesi"
                                                                            disabled></textarea>
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">ID
                                                                        Peserta</label>
                                                                </div>
                                                                <div class="col-lg-6">
                                                                    <input type="text" disabled class="form-control"
                                                                        placeholder="#id_klien" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label
                                                                        class="login2 pull-right pull-right-pro">Instansi</label>
                                                                </div>
                                                                <div class="col-lg-6">
                                                                    <input type="text" disabled class="form-control"
